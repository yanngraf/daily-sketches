...
let word = ['G','O','O','D','Y','E','A','R','R','T','_','T','O','_','Y','O','U','_','F','O','L','K','S','!','!'];
let
...
function draw() {
  ...
  for(var y = 150; y < height-scl; y=y+scl){
    ...
    for (var x = 20; x < width-scl; x = x+scl) {
      ...
      stroke('#271184');
      strokeWeight(15);
      textFont('Helvetica', (noiseValX))
      text(word[w], center_x, center_y);

      textFont('Times New Roman', (noiseValX/2))
      stroke('#fe3060');
      //fill('#271184');
